...
const emergencyPatientSchema = new mongoose.Schema({
    ...
    dateOfBirth: { type: String, required: true }, // Consider using Date type for easier date manipulation if needed later
    ...
    status: { type: String, default: 'Demande Enregistrée' }, // Added status field with default value

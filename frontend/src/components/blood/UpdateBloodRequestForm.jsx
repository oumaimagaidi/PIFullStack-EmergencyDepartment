        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 py-4 max-h-[70vh] overflow-y-auto pr-2">
            <div className="p-3 bg-gray-50 rounded-md border">
                ...
                <p className="text-xs text-gray-600">Patient Need: {request.bloodTypeNeeded} (Needed: {request.quantityNeeded} units)</p>
                <p className="text-xs text-gray-600">Current Status: {request.status}</p>
            </div>
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Quantity Fulfilled (units) *</FormLabel>
                  <FormControl>

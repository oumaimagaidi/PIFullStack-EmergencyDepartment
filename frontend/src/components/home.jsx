...
const Home = () => {
  const servicesArray = [
    ...
    },
    {
      ...
      description: "Your help can save a life. Find an active request below.",
    },
    {
  ...
  const newsArray = [
    {
      ...
      description:
        "UnitedHealth Group deploys 1,000 AI applications to enhance insurance, health delivery, and pharmacy services, improving patient outcomes.",
      date: "May 5, 2025",
      source: "PYMNTS.com",
    ...
    },
    {
      ...
      description:
        "55% of healthcare organizations postpone mental health initiatives due to tariff-driven supply chain issues, highlighting gaps in global health governance.",
      date: "May 7, 2025",
    ...
    },
    {
      ...
      description:
        "The smart wearable healthcare devices market is projected to reach USD 37.4 billion by 2028, driven by IoMT and proactive patient monitoring.",
      date: "May 2, 2025",
      source: "PR Newswire",
    ...
    },
    {
      ...
      description:
        "Blue Shield of California confirms the largest healthcare data breach of 2025, affecting 4.7 million patients due to a misconfigured Google Analytics setup.",
      date: "April 24, 2025",
      source: "TheStreet",
...

    {
      ...
      description:
        "A new report shows a 300% increase in telemedicine consultations in the last quarter, driven by convenience and accessibility.",
      date: "May 10, 2025",
    ...
    },
    {
      ...
      description:
        "Scientists announce a promising new therapy showing significant results in early-stage clinical trials for a common type of cancer.",
      date: "May 12, 2025",
  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      draw() {
        ctx.fillStyle = "rgba(148, 180, 193, 0.5)" // Updated to use the accent color
        ctx.beginPath()
        ...
        <section className="hero-section">
          <div className="hero-content">
            <div className="hero-text">
              ...
              <h1 style={{ color: colors.primary }}>Transforming Emergency Care with Smart Solutions</h1>
              <p>
                Our Intelligent Emergency Department Management System revolutionizes patient care by optimizing
                resources, reducing waiting times, and enhancing real-time collaboration among healthcare professionals.
              </p>
    ...
    Emergency Services
            ...
            <div className="hero-image">
              <div className="image-container">
                ...
                <div
                  ...
                  style={{
                    background: `radial-gradient(circle, rgba(148, 180, 193, 0.2) 0%, rgba(148, 180, 193, 0) 70%)`,
                  }}
                ></div>
              </div>
            </div>
          ...
          <div className="stats-bar">
            <div className="stat-item">
              <h3 style={{ color: colors.primary }}>24/24</h3>
              <p>Emergency Care</p>
            </div>
            <div className="stat-divider"></div>
            <div className="stat-item">
              <h3 style={{ color: colors.primary }}>15 min</h3>
            ...
            <div className="stat-divider"></div>
            <div className="stat-item">
              <h3 style={{ color: colors.primary }}>50,000+</h3>
              <p>Patients Served</p>
            </div>
          </div>
        </section>

        <section className="services-section" style={{ backgroundColor: colors.light, opacity: 0.9 }}>
          <div className="section-header">
            <h2 style={{ color: colors.primary }}>Our Services</h2>
          ...
          >
            {servicesArray.map((service, index) => (
              <div key={index} className="service-card" style={{ backgroundColor: colors.white }}>
                <div className="service-icon-container" style={{ backgroundColor: colors.primary }}>
                  {service.icon}
                </div>
                <h4 className="service-name" style={{ color: colors.primary }}>
                  {service.name}
                </h4>
                <p className="service-description">{service.description}</p>
                <Link
                  to={
                    service.name === "Patient Feedback"
                      ? "/feedback"
        ...
        <section className="about-section">
          <div className="about-content">
            <div className="about-image">
              ...
              <div className="image-accent" style={{ backgroundColor: colors.primary }}></div>
            </div>
            <div className="about-text">
              <div
                className="section-badge"
                style={{ backgroundColor: `rgba(148, 180, 193, 0.1)`, color: colors.primary }}
              >
                About Us
              </div>
              <h2 style={{ color: colors.primary }}>Who We Are</h2>
              <p className="about-description">
                Emergency departments (ED) play a crucial role as the first point of contact for patients requiring
                urgent medical attention. Our mission is to revolutionize emergency care through innovative technology
              ...
              <div className="about-features">
                <div className="feature">
                  ...
                  <div className="feature-text">
                    <h4 style={{ color: colors.primary }}>Modern Facilities</h4>
                ...
                <div className="feature">
                  ...
                  <div className="feature-text">
                    <h4 style={{ color: colors.primary }}>Rapid Response</h4>
                    <p>Quick and efficient emergency care when seconds count</p>
                  </div>
                </div>
              </div>
              <Link to="/about" className="about-btn-secondary" style={{ backgroundColor: colors.primary }}>
                Discover Our Story
              </Link>
            </div>
          </div>
        ...
        <style>
          {`
            ...
            .news-section .section-header h2 {
              ...
              font-weight: 700;
              background: linear-gradient(90deg, #213448, #547792);
            ...
            .news-card:hover {
              ...
              box-shadow: 0 15px 30px rgba(0, 0, 0, 0.25), 0 0 20px rgba(148, 180, 193, 0.5);
            }
            ...
            .news-title {
              ...
              background: linear-gradient(90deg, #fff, #94B4C1);
              -webkit-background-clip: text;
              -webkit-text-fill-color: transparent;
            }
            ...
            .news-link:hover {
              ...
              box-shadow: 0 0 15px rgba(148, 180, 193, 0.5);
            }

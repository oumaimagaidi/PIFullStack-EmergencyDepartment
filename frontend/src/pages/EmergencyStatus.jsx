            ...
            <div className="min-h-screen flex items-center justify-center pt-24 pb-20 px-4 md:px-6 relative z-10 bg-gradient-to-br from-[#FEE2C5] to-[#C4DDFF]">
                        ...
                        {loading ? (
                            ...
                            <>
                                <div className="border rounded-lg p-4 bg-gray-50 shadow-sm">
                                    ...
                                    <p className="text-xl font-bold text-[#213448]">{patientDetails.status || 'N/A'}</p>
                                ...
                                <div className="border rounded-lg p-4 bg-[#ECEFCA] shadow-sm">
                                    <h4 className="font-semibold mb-1 text-[#213448] flex items-center">
                                        <Clock className="mr-2 h-4 w-4 text-[#547792]" /> Temps d'Attente / Prochaine Étape
                                    </h4>
                ...
                {!loading && patientIdFromState && (
                    <>
                        {!showChatbot && (
                            <Button
                                className="fixed bottom-6 right-6 rounded-full w-14 h-14 shadow-lg text-white z-[100] flex items-center justify-center p-0"
                                style={{ backgroundColor: colors.primary, hover: colors.secondary }}

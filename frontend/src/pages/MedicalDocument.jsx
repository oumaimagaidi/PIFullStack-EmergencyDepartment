...
const MedicalDocument = () => {
          ...
          <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="grid gap-3">
                  {file.details.medications.map((med, idx) => (
                    <Card key={idx} className="border-l-4 shadow-sm" style={{ borderLeftColor: colors.primary }}>
            ...
            {file.notes && (
              <div className="mt-4 text-sm">
                ...
                <p className="text-slate-600 mt-1 p-3 bg-gray-50 rounded-md">{file.notes}</p>
              </div>
            )}
          ...
          <div className="space-y-4">
            ...
            {file.details?.diagnosis && (
              <div className="space-y-2">
                ...
                <Card className="border-l-4 shadow-sm" style={{ borderLeftColor: colors.secondary }}>
                  <CardContent className="p-3">
                      ...
                      <Badge
                        ...
                        style={
                          test.result.toLowerCase().includes("normal")
                            ...
                            : { backgroundColor: colors.alertLight, color: colors.alert, borderColor: colors.alert }
                        }
                      >
                        {test.result}
                      </Badge>
        ...
        return (
          <div className="space-y-4">
            ...
            {file.details?.procedures?.length > 0 ? (
              <div className="space-y-3">
                <h4 className="font-medium text-sm text-slate-700">Procedures</h4>
                <div className="grid gap-3">
                  {file.details.procedures.map((procedure, idx) => (
                    <Card key={idx} className="border-l-4 shadow-sm" style={{ borderLeftColor: "#f97316" }}>
                      <CardContent className="p-3">
                        <div className="flex justify-between items-start">
                          <div>
                            <div className="font-medium">{procedure.name}</div>
                            <div className="text-sm text-slate-500">
                              {procedure.date ? formatDate(procedure.date) : "Date not specified"}
                            </div>
                          </div>
                        </div>
                        {procedure.notes && (
                          <div className="mt-2 text-sm text-slate-600 p-2 bg-gray-50 rounded-md">{procedure.notes}</div>
                        )}
                      </CardContent>
                    </Card>
                  ))}
            ...
            {file.details?.diagnosticTests?.length > 0 && (
              <div className="space-y-2 mt-4">
                <h4 className="font-medium text-sm text-slate-700">Associated Tests</h4>
                <div className="grid gap-2">
                  {file.details.diagnosticTests.map((test, idx) => (
                    <div key={idx} className="flex justify-between items-center p-3 border rounded-md shadow-sm">
                      <div>
            ...
            {file.details?.medications?.length > 0 && (
              <div className="space-y-2 mt-4">
                <h4 className="font-medium text-sm text-slate-700">Associated Medications</h4>
                <div className="grid gap-2">
                  {file.details.medications.map((med, idx) => (
                    <div key={idx} className="flex justify-between items-center p-3 border rounded-md shadow-sm">
                      <div>
                    ...
                    <CardContent className="p-3">
                      <div className="flex items-center gap-3">
                        <div className="p-2 rounded-full" style={{ backgroundColor: colors.secondaryLight }}>
                          <Lungs className="h-5 w-5" style={{ color: colors.secondary }} />
                        </div>
                        <div>
                          <div className="text-sm text-slate-500">Respiratory Rate</div>
                  ...
                  <Card className="shadow-sm">
                    <CardContent className="p-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-sm text-slate-500">Oxygen Saturation</div>
        ...
        return (
          <div className="space-y-4">
            ...
            {file.details?.priorityLevel && (
              <div className="space-y-2">
                <h4 className="font-medium text-sm text-slate-700">Priority Level</h4>
                <Card
                  className="border-l-4 shadow-sm"
                  style={{ borderLeftColor: getPriorityColor(file.details.priorityLevel) }}
                >
                  <CardContent className="p-3">
            ...
            {file.details?.chiefComplaint && (
              <div className="space-y-2">
                <h4 className="font-medium text-sm text-slate-700">Chief Complaint</h4>
                <Card className="shadow-sm">
                  <CardContent className="p-3">
                    <p>{file.details.chiefComplaint}</p>
                  </CardContent>
                </Card>
              </div>
            )}
        ...
        return (
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-medium text-lg">Discharge</h3>
            </div>

            {file.details?.dischargeInstructions && (
              <div className="space-y-2">
                <h4 className="font-medium text-sm text-slate-700">Discharge Instructions</h4>
                <Card className="shadow-sm">
                  <CardContent className="p-3">
                    <p>{file.details.dischargeInstructions}</p>
                  </CardContent>
                </Card>
              </div>
            )}
            ...
            {file.details?.followUpDate && (
              <div className="space-y-2">
                <h4 className="font-medium text-sm text-slate-700">Follow-up Appointment</h4>
                <Card className="shadow-sm">
                  <CardContent className="p-3 flex items-center gap-2">
                    <CalendarClock className="h-5 w-5" style={{ color: colors.primary }} />
            ...
            {file.details?.medications?.length > 0 && (
              <div className="space-y-2 mt-4">
                <h4 className="font-medium text-sm text-slate-700">Medications to Continue</h4>
                <div className="grid gap-2">
                  {file.details.medications.map((med, idx) => (
                    <div key={idx} className="flex justify-between items-center p-3 border rounded-md shadow-sm">
                      <div>
                    ...
                    <dl className="space-y-2">
                      {file.details.patientInfo.phoneNumber && (
                        <div className="flex justify-between">
                          ...
                          <dd className="font-medium">{file.details.patientInfo.phoneNumber}</dd>
                        </div>
                      )}
                      {file.details.patientInfo.email && (
                        <div className="flex justify-between">
                          <dt className="text-sm text-slate-500">Email</dt>
                          <dd className="font-medium">{file.details.patientInfo.email}</dd>
                        </div>
                      )}
                      {file.details.patientInfo.emergencyContact && (
                        <div className="flex justify-between">
                          <dt className="text-sm text-slate-500">Emergency Contact</dt>
                          <dd className="font-medium">{file.details.patientInfo.emergencyContact}</dd>
                        </div>
                      )}
                      {file.details.patientInfo.insuranceInfo && (
                        <div className="flex justify-between">
                          <dt className="text-sm text-slate-500">Insurance</dt>
                          <dd className="font-medium">{file.details.patientInfo.insuranceInfo}</dd>
                        </div>
                      )}
                    </dl>
                  </CardContent>
                  ...
                  <CardContent className="pt-0">
                    <dl className="space-y-3">
                      {file.details.patientInfo.allergies && (
                        <div>
                          <dt className="text-sm text-slate-500 mb-1">Allergies</dt>
                          <dd className="font-medium p-2 bg-gray-50 rounded-md">
                            {file.details.patientInfo.allergies}
                          </dd>
                        </div>
                      )}
                      {file.details.patientInfo.currentMedications && (
                        <div>
                          <dt className="text-sm text-slate-500 mb-1">Current Medications</dt>
                          <dd className="font-medium p-2 bg-gray-50 rounded-md">
                            {file.details.patientInfo.currentMedications}
                          </dd>
                        </div>
                      ...
                      {file.details.patientInfo.medicalHistory && (
                        <div>
                          <dt className="text-sm text-slate-500 mb-1">Medical History</dt>
                          <dd className="font-medium p-2 bg-gray-50 rounded-md">
                            {file.details.patientInfo.medicalHistory}
                          </dd>
                        </div>
                    ...
                    <dl className="space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        {file.details.patientInfo.painLevel && (
                          <div>
                            <dt className="text-sm text-slate-500 mb-1">Pain Level</dt>
                        ...
                        {file.details.patientInfo.emergencyLevel && (
                          <div>
                            <dt className="text-sm text-slate-500 mb-1">Emergency Level</dt>
                            <dd className="font-medium">
                              <Badge
                                style={{
        ...
        return (
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-medium text-lg">Medical Document</h3>
            </div>
  ...
  // Utility functions for colors and translations
  ...
  const translatePriorityLevel = (level) => {
    switch (level) {
      case "Resuscitation":
  ...
  const renderMedicalRecord = () => {
    ...
    return (
      <div className="space-y-6">
        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-sky-500 to-cyan-500 p-4 rounded-lg text-white shadow-md">
          <div className="flex items-center">
          ...
          <Badge className="flex items-center self-start md:self-auto bg-white/20 border-white/40 text-white">
        ...
        <Tabs defaultValue="general" className="w-full">
          <TabsList className="grid grid-cols-4 mb-4 p-1 bg-gray-100 rounded-lg">
            <TabsTrigger
              value="general"
          ...
          <TabsContent value="general" className="space-y-4">
            <Card className="shadow-md border-t-4" style={{ borderTopColor: colors.primary }}>
              <CardHeader className="pb-2 bg-gray-50">
                <CardTitle className="text-lg flex items-center" style={{ color: colors.primary }}>
          ...
          <TabsContent value="medical" className="space-y-4">
            <Card className="shadow-md border-t-4" style={{ borderTopColor: colors.secondary }}>
              <CardHeader className="pb-2 bg-gray-50">
                <CardTitle className="text-lg flex items-center" style={{ color: colors.secondary }}>
                        ...
                        <div className="space-y-2">
                          {medicalRecord.knownAllergies.map((allergy, index) => (
                            <div
                              ...
                              style={{ backgroundColor: colors.alertLight, borderLeftColor: colors.alert }}
                            >
                              <AlertCircle className="h-4 w-4 mr-2" style={{ color: colors.alert }} />
                              {allergy}
                            </div>
                          ))}
                        </div>
                        ...
                        <div className="space-y-2">
                          {medicalRecord.chronicConditions.map((condition, index) => (
                            <div
                              key={index}
                              className="border-l-4 px-3 py-2 rounded-r text-sm flex items-center"
                              style={{ backgroundColor: colors.secondaryLight, borderLeftColor: colors.secondary }}
                            >
                        ...
                        <div className="space-y-2">
                          {medicalRecord.currentMedications.map((medication, index) => (
                            <div
                              ...
                              style={{ backgroundColor: colors.primaryLight, borderLeftColor: colors.primary }}
                            >
                ...
                {medicalRecord.patientFiles?.length > 0 ? (
                  <div className="space-y-6">
                    {medicalRecord.patientFiles.map((file) => (
                      <Card
                        key={file._id}
                        className="overflow-hidden transition-all hover:shadow-md border-0 shadow-sm"
                      >
                        <CardHeader className="pb-2 border-b" style={{ backgroundColor: colors.primaryLight }}>
                          <div className="flex justify-between items-start">
                            <div className="flex items-center">
                            ...
                            <Badge variant="outline" className="capitalize bg-white">
                              {file.creator?.username || "System"}
                            </Badge>
                          </div>
                        </CardHeader>
                        <CardContent className="pt-4 p-5">{renderFileDetails(file)}</CardContent>
                      </Card>
                    ))}
                  </div>
                ) : (
                  <div className="text-center py-12 bg-gray-50 rounded-lg border border-dashed">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-white mb-4 shadow-sm">
                      <FilePlus className="h-8 w-8" style={{ color: colors.primary }} />
                    </div>
          ...
          <TabsContent value="emergency" className="space-y-4">
            <Card className="shadow-md border-t-4" style={{ borderTopColor: colors.alert }}>
              <CardHeader className="pb-2 bg-gray-50">
                <CardTitle className="text-lg flex items-center" style={{ color: colors.alert }}>
              ...
              <CardContent className="p-6">
                {medicalRecord.emergencyContact ? (
                  <div
                    ...
                    style={{ backgroundColor: colors.alertLight, borderLeft: `4px solid ${colors.alert}` }}
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-3">
                        <div className="flex flex-col">
                  ...
                  <div className="text-center py-10 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-slate-500 mt-1">No emergency contact has been registered for this patient</p>
                  </div>
                )}
              </CardContent>
            </Card>
        ...
        <CardFooter className="flex justify-between pt-4 border-t">
          ...
          <div className="flex gap-2">
            <Button onClick={handleDownloadPDF} className="font-medium text-white bg-sky-500 hover:bg-sky-600">
              <FileText className="mr-2 h-4 w-4" />
              Download PDF
            </Button>

            <Button onClick={() => navigate("/home")} className="font-medium text-white bg-red-500 hover:bg-red-600">
              Back to Home
            </Button>
          </div>
        </CardFooter>
        ...
        {!isValid ? (
          <div className="overflow-hidden rounded-xl shadow-xl">
            <div className="grid md:grid-cols-5">
              <div className="md:col-span-2 hidden md:flex flex-col justify-center items-center p-8 bg-gradient-to-br from-sky-500 to-cyan-500">
                <div className="text-center text-white">
                  ...
                  <p className="mb-8 opacity-90 text-white/80">Secure access to your medical information</p>
              ...
              <Card className="md:col-span-3 border-0 md:border-0 md:rounded-l-none shadow-none">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        />
                        <Clipboard className="absolute left-4 top-3.5 h-5 w-5" style={{ color: colors.primary }} />
                      </div>
                    ...
                    {error && (
                      <Alert className="border-0" style={{ backgroundColor: colors.alertLight }}>
                    ...
                    <Button
                      type="submit"
                      className="w-full py-6 text-lg font-medium text-white bg-red-500 hover:bg-red-600 shadow-red-500/30 shadow-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 disabled:opacity-75"
                      disabled={loading}
                    >
                      {loading ? (
                ...
                <CardFooter className="flex flex-col space-y-4 border-t pt-6 pb-8">
                  <div className="text-sm text-gray-500 text-center w-full">
                    ...
                    <a href="tel:+21656800822" style={{ color: colors.primary }} className="font-medium">
                      +216 56 800 822
                    </a>
                  </div>
                </CardFooter>
